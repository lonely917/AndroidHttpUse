package http.wenburgyan.top.androidhttpuse.httpasyncclient;
...
public class HttpAsyncClientTest {
    ...
    //httpasyncclient的使用 org.apache.httpcomponents:httpasyncclient:4.1.4
    @Test
    public void testHttpAsyncClient() throws ExecutionException, InterruptedException, IOException {
        ...
        try {
            ...
            final HttpGet request2 = new HttpGet("http://10.2.2.2/");
